            ...
            <div class="card-body">
                ...
                <form action="fazerLogin.php" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nome" id="username" placeholder="Insira Seu Nome de Usuário">
                    </div>
                    <div class="mb-3">
                        <label for="password" class="form-label">senha</label>
                        <input type="password"  name="senha"  class="form-control" id="password" placeholder="Insira sua senha">
                    </div>
