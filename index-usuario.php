        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12 col-12 mt-md-5">
                <div class="about-text mt-lg-5">
                    ...
                    <p>No quitutes da vivi, não apenas alimentamos o corpo, mas também nutrimos a alma com o prazer de uma refeição extraordinária. A sua jornada gastronômica começa aqui, e estamos ansiosos para torná-la inesquecível. Agradecemos por escolher o nosso restaurante, onde cada refeição é uma celebração do sabor e da excelência culinária. Bom apetite!</p>
            ...
            <div class="col-md-12 p-0 pt-4 p-4 pb-4">
              <form action="" class="bg-light p-4 m-auto">
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            <input class="form-control" type="text" name="nome" placeholder="Seu nome completo">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                            <input class="form-control" type="text" name="email" placeholder="Seu e-mail completo">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                            <input class="form-control" type="text" name="telefone" placeholder="Insira um numero valido (55)9999-9999">
                        </div>
                    </div>
